...
public interface IIncidentRepository
{
    ...
    Task<IReadOnlyList<IncidentHistory>> GetOverlappingIncidentsAsync(int lineId, DateTime startTime, DateTime endTime, int? excludeIncidentId = null, CancellationToken cancellationToken = default);
