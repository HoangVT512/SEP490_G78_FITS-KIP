...
const ManagerUserGuide = () => {
    ...
    const loadGuideData = async () => {
        setLoading(true);
        try {
            const result = await window.storage.get('manager_guide');
                    ...
                    <div style={{ marginTop: 16 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                            ...
                            <div>
                                ...
                                <Text type="secondary">Quản lý - Hướng dẫn chi tiết</Text>
                            </div>
                        </div>
...
export default ManagerUserGuide;