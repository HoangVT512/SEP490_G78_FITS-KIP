                    ...
                    <div style={{ marginTop: 16 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                            <div style={{
                                width: 48,
                                height: 48,
                                background: 'linear-gradient(135deg, #eb2f96 0%, #eb2f96 100%)',
                                borderRadius: 8,
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center'
                            ...
                            <div>
                                ...
                                <Text type="secondary">Kỹ thuật viên - Hướng dẫn chi tiết</Text>
                            </div>
                        </div>
...
export default TechnicianUserGuide;