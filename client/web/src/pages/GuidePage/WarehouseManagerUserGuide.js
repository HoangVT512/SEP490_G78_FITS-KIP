...
const WarehouseManagerUserGuide = () => {
    ...
    const loadGuideData = async () => {
        setLoading(true);
        try {
            const result = await window.storage.get('technical_manager_guide');
                    ...
                    <div style={{ marginTop: 16 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                            <div style={{
                                width: 48,
                                height: 48,
                                background: 'linear-gradient(135deg, #faad14 0%, #faad14 100%)',
                                borderRadius: 8,
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center'
                            ...
                            <div>
                                ...
                                <Text type="secondary">Quản lý kho - Giám sát sản xuất</Text>
                            </div>
                        </div>
...
export default WarehouseManagerUserGuide;